		...
		<div class="container">
			<div class="row mt-5">
				<div class="col-md-12">
					...
					<div class="col-md-3">
						<a href="addlmsadmin" class="btn waves-effect waves-light col-md-12"><i
							class="material-icons fa fa-plus-circle"></i> Add New LMS Admin</a>
					</div>
							  ...
							  <c:forEach  items="${users}" var="user" varStatus="loop">  
									<tr>
													...
													<td>${loop.count}</td>		
						                      		...
						                      		<td>${user.email}   </td>
						                      		<td>${user.licenses}   </td>
						                      		<td><a  href="addlmsadmin?userId=${user.id}">Click to edit</a> </td>
