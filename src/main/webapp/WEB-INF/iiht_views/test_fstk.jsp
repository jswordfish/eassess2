				...
				<div class="col-md-6">
					<div class="userheader">
						<div class="userinfo">
							...
							<a href="signoff" id="signoff">Sign Off</a>
...
<a href="#" onClick = "javascript:openCodeBase('${currentQuestion.questionMapperInstance.workspaceUrl}', '${currentQuestion.questionMapperInstance.id}')">Open Code IDE in new Window</a>
