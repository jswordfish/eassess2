...
<div class="container">
	...
	<div class="jumbotron">
	 <h1 style="color:red">Sorry! ${firstName} ${lastName} - You can't apear for this test again</h1>
    <h2>You have exceeded the no of attempts configured for this test by the Test Admin</h2>
    <!--<h2>You have attempted this test - ${attempts} times</h2> -->
