                    ...
                    <div class="column col-sm-10 col-xs-11" id="main" style="overflow-x:scroll;overflow-y:scroll;">
                        ...
                        <div class="rightside" >
                            ...
                            <div class="rightdivTenant" >
                                <h2class="heading">${label} Create</h2>
                                <div class="addqueform" >
                                     <form name="tenantForm"  method="post" modelAttribute="cluster" action="saveCluster">
                                            ...
                                            <div class="selectoptions">
                                                ...
                                                <div id="maindivforaddmore">
                                                    ...
                                                    <div class="option">
                                                       ...
                                                       <form:input path="cluster.clusterName" name="clusterName" id="clusterName" required="true"/>
                                                    </div>
                                                    <div class="option">
                                                        <label>Cluster Url</label>
                                                       <form:input path="cluster.url" name="url" id="url" required="true"/>
													
													<form:hidden path="cluster.id" />
                                                    </div>
													
													<div class="option">
                                                        <label>Cluster Capacity (NRT - Update with Caution)</label>
                                                       <form:input path="cluster.noOfWorkspaces" name="noOfWorkspaces" id="noOfWorkspaces" />
                                                    </div>
                                                   
						    
						     <div class="formfield savebtn">
						    <input class="save" type="submit" value="${label} Cluster">
						
						    <input type="button" value="Cancel" onClick="location.href='showClusters';">
						</div>
                                                </div>
                                            </div>
