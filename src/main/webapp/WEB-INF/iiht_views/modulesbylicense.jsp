		...
		<div class="container">
			<div class="row mt-5">
				<div class="col-md-12">
					...
					<div class="col-md-2">
						<a href="licenses" class="btn waves-effect waves-light col-md-12"><i
							class="material-icons fa fa-sign-out"></i> Go Back</a>
					</div>
				</div>
						...
						<table class="table table-striped">
							<thead style="background-color: #03a9f4;">
								 <tr>
                                                ...
                                                <th>Module Name</th>
                                                <th >Module Desc</th>
												<th>Module Image Link</th>
                                                <th>Module Video Link</th>
							   ...
							   <c:forEach  items="${modules}" var="module" varStatus="loop">  
									<tr>
 													<td>${loop.count}</td>		
						                      		...
						                      		<td>${module.imageUrl}   </td>
					 								<td>${module.videoUrl}   </td>
									</tr>
								</c:forEach>
							</tbody>
