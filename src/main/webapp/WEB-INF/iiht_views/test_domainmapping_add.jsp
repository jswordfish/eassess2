                ...
                <div class="row row-offcanvas row-offcanvas-left">
                   ...
                   <jsp:include page="side.jsp" /> 
                    ...
                    <div class="column col-sm-10 col-xs-11" id="main" style="overflow-x:scroll;overflow-y:scroll;">
                        ...
                        <div class="rightside" >
                            ...
                            <div class="rightdivTenant" >
                                <h2class="heading">Create New Entry</h2>
                                <div class="addqueform" >
                                     <form name="tenantForm"  method="post" modelAttribute="mapping" action="saveDomainMapping">
					...
					<div class="formfield">
							...
							<form:select id="testName" path="mapping.testName">
							...
							<form:hidden path="mapping.id" />
                                                    ...
                                                    <div class="option">
                                                       ...
                                                       <form:input path="mapping.domainName" name="domainName" id="domainName" required="true"/>
                                                    </div>
                                                    <div class="option">
                                                        <label>No Of Attempts</label>
                                            
							<form:input path="mapping.noOfAttempts" name="noOfAttempts" id="noOfAttempts" required="true" onkeypress="return isNumberKey(event)" />
                                                    </div>
						    ...
						    <input type="button" value="Cancel" onClick="location.href='listDomainMappings';">
						</div>
                                                </div>
                                            </div>
