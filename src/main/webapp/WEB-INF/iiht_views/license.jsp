	...
	<section>
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<div class="mb-30">
						<h2 class="section-title">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspAdd/Update License</h2>
					</div>
						...
						<div class="col-md-12">
							<div class="col-md-8">
								<div class="row formfields">
									<div class="col-md-4">
										<label class="fieldtitle">Name of the License</label>
									</div>
									<div class="col-md-8">
							...
							<div class="col-md-8">
								<div class="row formfields">
									<div class="col-md-4">
										<label class="fieldtitle">Describe License</label>
									</div>
									<div class="col-md-8">
										<div class="input-field">
							...
							<div class="col-md-8">
								<div class="row formfields">
									<div class="col-md-4">
										<label class="fieldtitle">Image URL for License if applicable</label>
									</div>
									<div class="col-md-8">
										<div class="input-field">
						...
						<div class="col-md-12">
							<div class="col-md-8">
								<button type="submit" name="submit" class="waves-effect waves-light btn submit-button mt-30">Save License</button>
								<button type="button" class="waves-effect waves-light btn submit-button indigo mt-30"
									onClick="location.href='licenses';">Cancel</button>
							</div>
						</div>
					</form>
