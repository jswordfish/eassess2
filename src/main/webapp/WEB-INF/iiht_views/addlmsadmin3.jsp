			...
			<div class="row row-offcanvas row-offcanvas-left">
				...
				<div class="column col-sm-10 col-xs-11" id="main">
					...
					<div class="rightdivU">
						...
						<!-- -->
						<h2 class="heading">Add/Update User</h2>
								...
								<div class="formfield">
									<div class="selectoptions">
										...
										<div id="maindivforaddmore">
											...
											<div class="option">
												<label>Mobile</label>
												<form:password path="mobileNumber" name="mobileNumber" id="mobileNumber"
													required="true" />
											</div>
											...
											<div class="option">
												...
												<form:select path="lic" multiple="true">
...
<!-- 												<input class="save" type="submit" value="Save User"> <input type="button" -->
<!-- 													value="Cancel" onClick="location.href='lmsAdmins';"> -->
											</div>
										</div>
									</div>
