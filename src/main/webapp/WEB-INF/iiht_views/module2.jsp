        ...
        <div class="maincontainer">            
                   ...
                   <jsp:include page="side.jsp" /> 
                    ...
                    <div class="column col-sm-10 col-xs-11" id="main" style="overflow-x:scroll;overflow-y:scroll;">
                        ...
                        <div class="rightside" >
                            ...
                            <div class="rightdivTenant" >
                                <h2class="heading">Add or Update Module</h2>
                                <div class="addqueform" >
                                     <form name="moduleForm" id="moduleForm" method="post" modelAttribute="module" action="saveModule">
					...
					<div class="formfield">
							...
							<form:hidden path = "module.id"  />
                                                    ...
                                                    <div class="option">
                                                        <label>Image URL (if applicable)</label>
                           <form:input path="module.imageUrl" name="imageUrl" id="imageUrl" />
                                                    </div>
                                                    <div class="option">
                                                        <label>Video URL (if applicable)</label>
                           <form:input path="module.videoUrl" name="videoUrl" id="videoUrl" />
										...
										<form:select path="module.lics" multiple="true">
											<form:options items="${licenses}"/>
										</form:select>
                                                    </div>
													
							<div class="option">
                                                        <label>Add/Edit Module Items</label>
														<a  href="javascript:addModuleItem()">Click to Add </a>
                                            <!--start -->
										<div class="questiontablelist" style="height: 350px;">
                                    <table class="table" >
                                        <thead>
                                            <tr>
                                                <th><b>No</b></th>
					...
					<tbody>
						    ...
						    <input class="save" type="submit" value="Save Module">
						
						    <input type="button" value="Cancel" onClick="location.href='modules';">
						</div>
                                                </div>
                                            </div>
			...
			<script>
				function addModuleItem(){
					document.getElementById("moduleForm").action = 'moduleitem';
