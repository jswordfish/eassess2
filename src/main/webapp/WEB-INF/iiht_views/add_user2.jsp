		...
		<div class="container">
			<div class="row mt-5">
				<div class="col-md-12">
					...
					<div class="col-md-2">
						<a href="addUser" class="btn waves-effect waves-light col-md-12"><i
					...
					<form id="fileFormUsers" method="POST" enctype="multipart/form-data">
						<input type="file" name="fileFromUserForm" id="fileFromUserForm"
							style="display: none" />
					</form>
					...
					<div class="col-md-4">
						<div class="widget widget_search">
							...
							<div class="search-form">
								<form action="searchUsrs" method="get">
