					...
					<div class="col-md-12">
						...
						<div class="col-md-12 text-right">
							...
							<a class="waves-effect waves-light btn cyan mt-20 mb-20"
								href="lmsGobackStep1Test">Back</a> <a
								class="waves-effect waves-light btn mt-20 mb-20" href="lmsAddteststep3">Next</a>
						</div>
					</div>
			...
			<div class="modal-content" style="display: inline-block;">
				...
				<div class="modal-body">
					<div class="col-md-12 mb-20">
						<a href="lmsAddteststep2" class="btn waves-effect waves-light">Show All Parent
						...
						<!--  <a
														...
														class="btn waves-effect waves-light green">Show Selected</a>  -->
						<a href="lmsRemoveAllQuestions" class="btn waves-effect waves-light red">Clear
							All</a>
					...
					<div class="col-md-12 mb-20">
						...
						<div class="col-md-4">
							<div class="widget widget_search">
								...
								<div class="search-form">
									<form action="lmsSearchQuestions2" method="get">
