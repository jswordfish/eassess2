				...
				<div class="col-md-12">
					...
					<div class="col-md-4">
						<a href="addTestLink"
							...
							class="material-icons fa fa-plus-circle"></i> Create New Public Test Link</a>
					</div>
				...
				<div class="col-md-12">
					...
					<div class="col-md-8">
						<h1 style="color: #b07c2a;">
							<b>Time Bound Public Test Links </b>
						</h1>
					</div>
						...
						<table class="table table-striped" id="tbl">
						 ...
						 <c:forEach  items="${links}" var="link" varStatus="loop">  
										...
										<td>${loop.count}</td>		
						                      		...
						                      		<td> ${link.edDate}</td>
													<td> ${link.url}</td>
						                <td><a  href="addTestLink?linkId=${link.id}">Click </a> </td>
...
function confirmDelete(id) {
   ...
   (new PNotify({
    ...
    text: 'Are you sure? Do you really want to delete this public link. Candidates may have access to this link and may no longer be able to use it?',
    ...
    window.location = "deleteTestLink?linkId="+id;
