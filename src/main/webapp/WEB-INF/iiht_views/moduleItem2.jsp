...
<html>
    ...
    <body>
                    ...
                    <div class="column col-sm-10 col-xs-11" id="main" style="overflow-x:scroll;overflow-y:scroll;">
                        ...
                        <div class="rightside" >
                            ...
                            <div class="rightdivTenant" >
                                <h2class="heading">Add/Update Module Item</h2>
                                <div class="addqueform" >
                                     <form name="moduleItemForm"  method="post" modelAttribute="moduleItem" action="saveModuleitem">
		...
		<form:input path="moduleItem.externalVideoUrl" name="externalVideoUrl" id="externalVideoUrl" />
						...
						<div class="option">
							<label>Test for the Module</label>
		<form:select path="moduleItem.testName" required="true" >
		...
		<form:input path="moduleItem.testDescription" name="testDescription" id="testDescription" />
						    ...
						    <input class="save" type="submit" value="Save Item">
						<%
						Module module = (Module) request.getSession().getAttribute("module");
						
						%>
						    <!-- <input type="button" value="Cancel" onClick="location.href='module?moduleId=${module.id}';"> -->
						</div>
                                                </div>
                                            </div>
