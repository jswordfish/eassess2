...
public interface UserService {
	...
	List<User> findByInstituteGradeClassifier(String companyId, String collegeName, String grade,
			String classifier);

	List<String> findEmailByInstituteGradeClassifier(String companyId, String collegeName, String grade,
			String classifier);
}
