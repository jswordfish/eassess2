...
//		return list;
	...
	public QuestionMapperInstance findUniqueQuestionMapperInstanceForUser(String questionText, String testName,
		...
		return questionMapperInstanceRepository.findUniqueQuestionMapperInstanceForUser(questionText,
	...
	public boolean canEditTest(String sectionName, String testName, String companyId) {
		...
		List<QuestionMapperInstance> list = questionMapperInstanceRepository
				.findQuestionMapperInstancesForTestAndSection(sectionName, testName,
						companyId);
	...
	public List<QuestionMapperInstance> findFullStackQuestionMapperInstancesForJavaScript(String companyId) {
		...
		return questionMapperInstanceRepository
				.findFullStackQuestionMapperInstancesForJavaScript(companyId);
	}
	...
	public List<QuestionMapperInstance> findQuestionMapperInstancesForUserForCourseContext(String courseContext,
		...
		// TODO Auto-generated method stub
		return questionMapperInstanceRepository.findQuestionMapperInstancesForUserForCourseContext(
				courseContext, user, companyId);
	}
	...
	public List<String> findQuestionMapperInstancesForUserLastAttemptForCourseContext(String courseContext,
			String user, String companyId) {
		// TODO Auto-generated method stub
		return questionMapperInstanceRepository.findUniqueUsersForCourseContext(courseContext, user,
				companyId);
	}
	...
	public List<String> findUniqueTestsForCourseContext(String courseContext, String user, String companyId) {
		// TODO Auto-generated method stub
		return questionMapperInstanceRepository.findUniqueTestsForCourseContext(courseContext, user,
				companyId);
	}

	@Override
	public List<String> findUniqueUsersForCourseContextAndTest(String testName, String courseContext,
			String user, String companyId) {
		// TODO Auto-generated method stub
		return questionMapperInstanceRepository.findUniqueUsersForCourseContextAndTest(testName,
				courseContext, user, companyId);
	}

	@Override
	public List<QuestionMapperInstance> findQuestionMapperInstancesForUserForCourseContextAndTest(
			String testName, String courseContext, String user, String companyId) {
		// TODO Auto-generated method stub
	...
	public Float getWeightedTestScore(String user, String testName, String companyId) {
		// TODO Auto-generated method stub
		List<QuestionMapperInstance> instances = findQuestionMapperInstancesForUserForTest(testName, user,
				companyId);
	...
	public QuestionMapperInstance removeDublicateAndGetInstance(String questionText, String testName,
		...
		try {
			...
			List<QuestionMapperInstance> annswers = questionMapperInstanceRepository
					.findUniqueQuestionMapperInstanceForUserSet(questionText,
							testName, sectionName, user, companyId);
			...
			if (annswers == null || annswers.size() == 0) {
				...
				if (questionText != null && questionText.contains("\r")
					...
					annswers = questionMapperInstanceRepository
							.searcUniqueQuestionMapperInstanceForUserSet(
									questionText,
									testName,
									sectionName, user,
									companyId);
					...
					if (annswers == null || annswers.size() == 0) {
						...
						QuestionType type = annswers.get(0)
								.getQuestionMapper()
								.getQuestion()
								.getQuestionType();
						logger.info("size returned " + annswers.size());
						if (type.getType().equalsIgnoreCase(
								QuestionType.FULL_STACK_JAVA
										.getType())
								|| type.getType().equalsIgnoreCase(
										QuestionType.FULLSTACK.getType())) {
							logger.info("size returned xxx "
									+ annswers.size());
			...
			e.printStackTrace();
			logger.error("should not come here duplicate anss for " + questionText + "-" + testName
					+ "-" + sectionName + "-" + user + "-" + companyId);
			List<QuestionMapperInstance> qms = questionMapperInstanceRepository
					.findDuplicateQuestionMapperInstanceForUser(questionText,
							testName, sectionName, user, companyId);
	...
	@Override
	public List<QuestionMapperInstance> findSubjectQuestionMapperInstancesForUserAndTest(String testName,
			String user, String companyId) {
		// TODO Auto-generated method stub
		return questionMapperInstanceRepository.findSubjectQuestionMapperInstancesForUserAndTest(testName,
				user, companyId);
	}

	@Override
	public QuestionMapperInstance findById(Long id) {
		// TODO Auto-generated method stub
		return questionMapperInstanceRepository.findById(id).get();
	}
