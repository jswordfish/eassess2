...
public class TestServiceImpl implements TestService {
	...
	@Override
	public List<TestLinkDTO> getAllTests(String companyId) {
		// TODO Auto-generated method stub
		return testRepository.getAllTests(companyId);
	}

	@Override
	public List<String> getTestNames(String companyId) {
		// TODO Auto-generated method stub
		return testRepository.getTestNames(companyId);
	}
