...
public class ReportManagerTrait {
	...
	public DynamicReport buildPieChart(String candidateName, String testName){
	 ...
	 public DynamicReport buildBarReport(String candidateName, String testName, String averageScore, String weightedScore) throws Exception {
		 StyleBuilder titleStyle=new StyleBuilder(true);
         titleStyle.setHorizontalAlign(HorizontalAlign.CENTER);
       //  titleStyle.setf
         Font font = new Font();
       ...
       titleStyle.setFont(font);
        ...
        // subTitleStyle.setFont(new Font(Font.MEDIUM, Font._FONT_TIMES_NEW_ROMAN, true));
         ...
         if(averageScore != null && weightedScore != null){
        	 builder2.setSubtitle("Average Score - "+averageScore+" Weighted Score - "+weightedScore);
         }
	...
	public String buildComprehensiveReport(List<UserTrait> traits, List<UserSkillArea> areas, String testName, String canddateName, String averageScore, String weightedScore) throws Exception{
		try {
...
//	 .title(com.assessment.reports.manager.Templates.createTitleComponent("Comprehensive Report - Jatin sutaria"));
			...
			DynamicReport dynamicReport = buildBarReport(canddateName, testName, averageScore, weightedScore);
