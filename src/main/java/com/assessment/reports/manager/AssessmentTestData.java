...
public class AssessmentTestData {
	...
	public AssessmentTestData(Float percentageMarksRecieved, String testName, String user, Integer noOfAttempts, Boolean pass, String sectionResults,String companyId, Date testInviteSent, Boolean sharedDirect, String noOfQuestionsNotAnswered, Date testStartDate, Date testEndDate, Float weightedScorePercentage) {
	...
	public Float getWeightedScorePercentage() {
		if(this.weightedScorePercentage == null){
			return this.getPercentageMarksRecieved();
		}
