...
public class TestReports {
	...
	public void testGranulaReport() throws Exception{
		...
		managerTrait.buildComprehensiveReport(traits, skillAreas, "General Composite Test", "Jatin Sutaria", null, null);
	}
	...
	public void testGetTestData() throws MalformedURLException {
		AssessmentReportDataManager assessmentReportDataManager = new AssessmentReportDataManager(testService, userTestSessionRepository, sectionService, userService, "IH", "Jatin Sutaria");
